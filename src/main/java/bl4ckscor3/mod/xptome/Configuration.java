...
public class Configuration {
	...
	Configuration(ForgeConfigSpec.Builder builder) {
		//@formatter:off
		maxXP = builder
				.comment("The maximum amount of XP points that the XP Tome can hold. The default value (133335) represents having 125 levels.")
				.defineInRange("max_xp", 133335, 1, Integer.MAX_VALUE);
